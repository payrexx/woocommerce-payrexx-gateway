...
class PaymentHelper
{
	public static function handleError(): void {
		...
		// A sibling attempt on the same gateway may have paid; don't cancel on redirect while
		// a live transaction exists - let the webhook settle it (PP-20477).
		if ( ! $payrexxApiService->gatewayHasLiveTransaction( $gatewayId ) ) {
